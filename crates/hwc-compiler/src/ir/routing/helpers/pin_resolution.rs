...
pub fn get_pin_ids(
    ...
    eprintln!("[DEBUG get_pin_ids] Called with {} entities registered", 
    ...
    eprintln!("[DEBUG] Constructing EntityId for space entity: space:{}", from_label);
    ...
    let from_entity_data = space.entity_graph.get_entity_data(from_entity_id)
    ...
    eprintln!("[DEBUG] Found entity '{}', net_id: {:?}", from_label, from_entity_data.net_id);
    ...
    eprintln!("[DEBUG] Entity '{}' has valid net_id, continuing...", from_label);
    ...
    eprintln!("[DEBUG] Entity '{}' has valid net_id, continuing...", to_label);
